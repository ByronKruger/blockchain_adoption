...
exports.default = function (config) {
  ...
  return {
    ...
    createElement_FieldBody: _react2.default.createFactory(_fieldBody2.default),
    ...
    createRootField: function createRootField(props) {
      ...
      var field = _undash2.default.extend({}, fieldTemplate, {
    ...
    childFieldTemplateForValue: function childFieldTemplateForValue(field, childValue) {
      ...
      var fieldTemplate = _undash2.default.find(fieldTemplates, function (itemFieldTemplate) {
...
var _prettyText = require('./components/fields/pretty-text');
...
var _fieldBody = require('./components/helpers/field-body');
