...
var PrettyTagField = createReactClass({
  ...
  renderDefault: function renderDefault() {
    ...
    return (
      ...
      React.createElement(
        'span',
        { role: 'button', className: classes, onClick: this.props.onClick },
        this.props.children
      )
    );
  }
...
var FieldHelper = createReactClass({
  ...
  renderDefault: function renderDefault() {
    ...
    var content = config.cssTransitionWrapper(this.state.collapsed ? [label] : [config.createElement('field-body', {
      config: config,
      label: label,
...
var FieldBody = function FieldBody(props) {
  return React.createElement(
    React.Fragment,
    null,
    props.label,
...
var HelpHelper = createReactClass({
  ...
  renderDefault: function renderDefault() {
    ...
    return helpText ? React.createElement('div', {
      className: cx(this.props.classes),
  ...
  renderDefault: function renderDefault() {
    ...
    return React.createElement(
      ...
      config.cssTransitionWrapper(search, React.createElement(
        'ul',
        { key: 'choices', ref: ref(this, 'choices'), className: 'choices' },
...
var ChoiceHelper = createReactClass({
  ...
  renderDefault: function renderDefault() {
    ...
    return (
      ...
      React.createElement(
        'a',
        { role: 'option', style: { cursor: 'pointer' }, onClick: this.onSelect },
        React.createElement(
          'span',
...
var ArrayItemControlHelper = createReactClass({
  ...
  renderDefault: function renderDefault() {
    ...
    var moveItemForward = this.props.index < this.props.numItems - 1 ? config.createElement('move-item-forward', {
      field: field,
      onClick: this.onMoveForward,
      classes: { 'is-first-item': isFirstItem }
    }) : null;

    var moveItemBack = this.props.index > 0 ? config.createElement('move-item-back', {
      field: field,
...
var PrettySelectValueHelper = createReactClass({
  ...
  renderDefault: function renderDefault() {
    ...
    if (!this.isReadOnly() || this.hasReadOnlyControls()) {
      selectArrow = React.createElement('span', {
    ...
    var choicesOrLoading = React.createElement(
      'div',
      {
        role: 'listbox',
        ref: ref(this, 'container'),
        ...
        className: cx(_.extend({}, this.props.classes, {
...
var PrettyTextInputHelper = createReactClass({
  ...
  componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
    var hasReplaceChoicesChanged = !_.isEqual(prevProps.replaceChoices, this.props.replaceChoices);
  ...
  tagCodeMirror: function tagCodeMirror(cursorPosition) {
    ...
    if (this.isDebouncingCodeMirrorChange) {
      ...
      requestAnimationFrame(function () {
        _this4.maybeCodeMirrorOperation(tagOps);
...
function defaultConfigPlugin (config) {
  ...
  return {
    ...
    createRootField: function createRootField(props) {
      ...
      var field = _.extend({}, fieldTemplate, {
    ...
    childFieldTemplateForValue: function childFieldTemplateForValue(field, childValue) {
      ...
      var fieldTemplate = _.find(fieldTemplates, function (itemFieldTemplate) {
    ...
    normalizeChoices: function normalizeChoices(choices) {
      ...
      var choicesWithLabels = choices.map(function (choice) {
        ...
        return !maybeStringChoice.label ? Object.assign({}, maybeStringChoice, {
    ...
    customChoiceDisplayValue: function customChoiceDisplayValue(customChoice) {
...
function bootstrapPlugin (config) {
...
function referencePlugin (config) {
  var _initField = config.initField;
...
function elementClassesPlugin (config) {
  var _createElement = config.createElement;
...
var helpTextPlacementPlugin = (function (placement) {
  return function () /* config */{
    return {
      createElement_FieldBody: React.createFactory(function (props) {
        return placement === 'after' ? React.createElement(
          React.Fragment,
          null,
          props.label,
          props.children,
