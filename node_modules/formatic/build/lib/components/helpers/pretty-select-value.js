...
exports.default = (0, _createReactClass2.default)({
  ...
  renderDefault: function renderDefault() {
    ...
    if (!this.isReadOnly() || this.hasReadOnlyControls()) {
      selectArrow = _react2.default.createElement('span', {
        className: (0, _classnames2.default)('select-arrow', {
          'readonly-control': this.isReadOnly()
        })
      });
    }

    var choicesOrLoading = _react2.default.createElement(
      'div',
      {
        role: 'listbox',
        ...
        className: (0, _classnames2.default)(_undash2.default.extend({}, this.props.classes, {
